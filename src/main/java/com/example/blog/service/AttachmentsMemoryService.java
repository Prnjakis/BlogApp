...
import com.example.blog.model.Attachments;
...
public class AttachmentsMemoryService implements AttachmentsManager {
    ...
    @Autowired
    public AttachmentsMemoryService(List<Attachments> attachmentsList, AttachmentsRepository attachmentsRepository, PostsRepository postsRepository) {

...
public class CommentsMemoryService implements CommentsManager {
    ...
    @Autowired
    public CommentsMemoryService(CommentsRepository commentsRepository, List<Comments> commentsList, PostsRepository postsRepository) {

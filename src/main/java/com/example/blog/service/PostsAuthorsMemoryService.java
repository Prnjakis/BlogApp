...
import com.example.blog.model.PostsAuthorsId;
...
@Service
@Transactional
public class PostsAuthorsMemoryService implements PostsAuthorsManager {
    ...
    @Autowired
    public PostsAuthorsMemoryService(AuthorsRepository authorsRepository, PostsRepository postsRepository, PostsAuthorsRepository postsAuthorsRepository, List<PostsAuthorsId> postsAuthorsList, PostsInMemoryService postsInMemoryService, AuthorsMemoryService authorsMemoryService) {
